...
class DapurMenuHarianCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final costLabel = '${currencyFormatter.format(menuHarian.biayaPerTray)}/tray';
    final formattedDate = DateFormat('EEEE, dd MMM yyyy').format(menuHarian.tanggal);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Icon(Iconsax.calendar, size: MBGSizes.iconSm, color: colors.onSurface.withOpacity(0.6)),
          ...
          Row(
            children: [
              Container(
                padding: const EdgeInsets.symmetric(horizontal: MBGSizes.md, vertical: MBGSizes.sm),
                decoration: BoxDecoration(
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(Iconsax.box, size: MBGSizes.iconSm, color: colors.primary),
                    const SizedBox(width: MBGSizes.xs),
                    Text(
          ...
          Row(
            ...
            children: [
              DapurMenuHarianNutricionInfo(label: 'Kalori', value: menuHarian.kalori, unit: 'kcal', icon: Icons.local_fire_department),
              DapurMenuHarianNutricionInfo(label: 'Protein', value: menuHarian.protein, unit: 'g', icon: Icons.egg),
              DapurMenuHarianNutricionInfo(label: 'Karbo', value: menuHarian.karbohidrat, unit: 'g', icon: Icons.grain),
              DapurMenuHarianNutricionInfo(label: 'Lemak', value: menuHarian.lemak, unit: 'g', icon: Icons.water_drop),
            ],
          ),
