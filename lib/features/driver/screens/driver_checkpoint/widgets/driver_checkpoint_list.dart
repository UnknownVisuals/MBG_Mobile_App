...
import 'package:mbg_mobile_app/features/driver/screens/driver_checkpoint/widgets/driver_checkpoint_event_card.dart';

class DriverCheckpointList extends StatelessWidget {
  const DriverCheckpointList({super.key});
      ...
      builder: TimelineTileBuilder.connected(
        ...
        contentsBuilder: (context, index) {
          ...
          return Padding(
            ...
            child: DriverCheckpointEventCard(
              tipe: tipe,
              status: status,
