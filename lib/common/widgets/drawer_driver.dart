...
/// Drawer for DRIVER role
class MBGDrawerDriver extends StatelessWidget {
  const MBGDrawerDriver({
    super.key,
          ...
          () => SidebarX(
            ...
            items: [
              ...
              SidebarXItem(
                ...
                label: 'Setting',
                onTap: () {
                  driverController.drawerSelectedIndex.value = 4;
                  Navigator.of(context).pop();
                },
              ),
            ],
